...
-(void)drawSpriteWithBrush:(__unsafe_unretained id<SCIBrush2DProtocol>)brush fromX:(float)startX Y:(float)startY toX:(float)endX Y:(float)endY swapVertically:(BOOL)swapVertically swapHorizontally:(BOOL)swapHorizontally;
