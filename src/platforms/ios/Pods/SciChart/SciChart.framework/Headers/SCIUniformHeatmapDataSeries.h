 ...
 */
@property SCIGenericType stepX;

/**
 * The step of y values.
 */
@property SCIGenericType stepY;
 ...
 * @param values The new Z values
 */
-(void) updateRangeZAtXIndex: (int)xIndex yIndex:(int)yIndex withValues:(SCIArrayController2D*) values;
...
-(id)initWithZValues:(SCIArrayController2D*) array2D
            StartX:(SCIGenericType)startX StepX:(SCIGenericType)stepX
            StartY:(SCIGenericType)startY StepY:(SCIGenericType)stepY;
